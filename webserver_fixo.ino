...
IPAddress ip(192,168,0,144); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR. EX: 192.168.0.144 **** ISSO VARIA, NO MEU CASO É: 192.168.0.0 ATÉ 192.168.0.255
...
void loop() {
    ...
    Serial.println("Novo cliente"); //ESCREVE O TEXTO NA SERIAL
    ...
    client.println("<meta charset=\"UTF-8\">"); //CODIFICA A ACENTUACAO
    client.println("<title>Página do cliente</title>"); //DEFINE O TITULA DA PAGINA
    client.println("<h1><center>Olá cliente!</center></h1>"); //ESCREVE "Ola cliente!" NA PÁGINA
    client.println("<center><font size='5'>Página para o cliente</font></center>"); //ESCREVE "Pagina do cliente" NA PÁGINA
    client.println("<center><font size='5' color='red'>By dev.fácil</font></center>"); //ESCREVE "Pagina do cliente" NA PÁGINA
